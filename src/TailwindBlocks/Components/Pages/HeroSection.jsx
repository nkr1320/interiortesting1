  ...
  return (
    <>
      <section id="HeroSection" className="text-gray-600 body-font">
        ...
        <div
          className="relative container mx-auto flex px-5 py-24 md:flex-row flex-col items-center"
          style={{
        ...
        >
          ...
          <div className="relative z-10 lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-center md:text-center mb-16 md:mb-0 items-center text-center">
            <h1 className="title-font sm:text-6xl text-4xl mb-9 mt-27 font-medium text-white">
              IMAGINE IT
              <br />
              DESIGN IT
              <br />
            ...
            <p className="mb-8 sm:text-2xl text-[10px] font-medium leading-relaxed text-white">
            ...
            <div className="flex justify-center mb-15" >
              ...
              {/* WhatsApp button */}
              <a
                href="https://wa.me/919849003576" // Replace with your real number
...
<div className="relative z-10 lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mr-2 lg:mr-15 mt-9">
