...
<section id="ContentSection" className="relative w-[90%] lg:w-[86.1%] lg:mx-auto h-[calc(100vh-210px)] lg:h-screen overflow-hidden text-white flex items-center justify-center m-[20px] rounded-2xl sm:mr-0 sm:p-15 sm:rounded-none">
      {/* Background Image */}
      <img
        src={current.img}
